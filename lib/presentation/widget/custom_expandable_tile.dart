...
///
/// This task is typically used with [ListView] to create an
...
class CustomExpansionTile extends StatefulWidget {
  ...
  /// A task to display before the title.
  ///
  /// Typically a [CircleAvatar] task.
  ///
  /// Note that depending on the value of [controlAffinity], the [leading] task
  /// may replace the rotating expansion arrow icon.
  final Widget? leading;

  /// The primary content of the list item.
  ///
  /// Typically a [Text] task.
  final Widget title;
  ...
  ///
  /// The internals of the expanded tile make use of a [Column] task for
  /// [children], and [Align] task to align the column. The `expandedAlignment`
  ...
  ///
  /// The width of the column is the width of the widest child task in [children].
  ///
  ...
  /// [children] will be the same as the widest child task in [children]. It is
...
class _CustomExpansionTileState extends State<CustomExpansionTile> with SingleTickerProviderStateMixin {
  ...
  void didChangeDependencies() {
    ...
    _borderColorTween.end = (widget.dividerColor != null) ? widget.dividerColor :theme.dividerColor;
    _headerColorTween
